<div class="container-fluid">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="col-md-12">
                    <h5 class="card-title fw-semibold mb-4">Delivery Order Record</h5>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>ID Delivery Order</label>
                                                <input type="text" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label>No Dev. PNBP</label>
...
<script>
    $(function() {
        ...
        function fetchAllPosts() {
            ...
            $.ajax({
                url: '<?= base_url('RecordHandle/DeliveryRead') ?>',
                method: 'get',
        ...
        //     $.ajax({
        //         method: "post",
        //         url: '<?= base_url('RecordHandle/DeliveryCreate') ?>',
        //         data: data,
        //         dataType: "JSON",
        //         success: function(response) {
